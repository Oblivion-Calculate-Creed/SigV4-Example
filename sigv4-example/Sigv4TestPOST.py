...
# This version makes a POST request and passes request parameters in the body (payload) of the request. 
# Auth information is passed in an Authorization header.
...
## Step 3: Create the canonical query string. In this example, request parameters are passed in the body of the request 
...
# from low to high. Note that there is a trailing \n.
canonical_headers = 'content-type:' + content_type + '\n' + 'host:' + host + '\n' + 'x-amz-date:' + amz_date + '\n' + 'x-amz-target:' + amz_target + '\n'

# Step 5: Create the list of signed headers. This lists the headers in the canonical_headers list, 
...
# For DynamoDB, the request can include any headers, but MUST include "host", "x-amz-date", "x-amz-target", "content-type", 
# and "Authorization". 
# Except for the authorization header, the headers must be included in the canonical_headers and signed_headers values.
